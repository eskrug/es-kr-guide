...
{% tab title="request" %}
{% code-tabs %}
{% code-tabs-item title="quick dog 를 포함한 도큐먼트 검색" %}
```javascript
...
{% tab title="response" %}
{% code-tabs %}
{% code-tabs-item title="quick dog 를 포함한 도큐먼트 검색 결과" %}
```javascript
{
  "took" : 1,
  "timed_out" : false,
...
{% tab title="request" %}
{% code-tabs %}
{% code-tabs-item title="검색어 lazy 를 포함한 도큐먼트 검색" %}
```javascript
GET my_index/_search
{
  "query": {
...
{% tab title="response" %}
{% code-tabs %}
{% code-tabs-item title="검색어 lazy 를 포함한 도큐먼트 검색 결과" %}
```javascript
{
  "took" : 1,
  "timed_out" : false,
