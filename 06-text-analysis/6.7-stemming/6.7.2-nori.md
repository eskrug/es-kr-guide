...
{% code-tabs %}
{% code-tabs-item title="decompound\_mode 모드를 각각 none, discard, mixed 로 설정한 토크나이저 설장" %}
```javascript
PUT my_nori
{
  "settings": {
...
{% tab title="request" %}
{% code-tabs %}
{% code-tabs-item title="nori\_none 토크나이저로 \"백두산이\" 분석" %}
```javascript
GET my_nori/_analyze
{
  "tokenizer": "nori_none",
...
{% tab title="response" %}
{% code-tabs %}
{% code-tabs-item title="nori\_none 토크나이저로 \"백두산이\" 분석 결과" %}
```javascript
{
  "tokens" : [
    {
...
{% tab title="request" %}
{% code-tabs %}
{% code-tabs-item title="nori\_discard 토크나이저로 \"백두산이\" 분석" %}
```javascript
GET my_nori/_analyze
{
...
{% tab title="response" %}
{% code-tabs %}
{% code-tabs-item title="nori\_discard 토크나이저로 \"백두산이\" 분석 결과" %}
```javascript
{
  "tokens" : [
    {
...
{% tab title="request" %}
{% code-tabs %}
{% code-tabs-item title="nori\_mixed 토크나이저로 \"백두산이\" 분석" %}
```javascript
GET my_nori/_analyze
{
...
{% tab title="response" %}
{% code-tabs %}
{% code-tabs-item title="nori\_mixed 토크나이저로 \"백두산이\" 분석 결과" %}
```javascript
{
  "tokens" : [
    {
...
{% code-tabs %}
{% code-tabs-item title="stoptags 디폴트 값" %}
```javascript
"stoptags": [
  "E", "IC", "J", "MAG", "MAJ",
  "MM", "SP", "SSC", "SSO", "SC",
...
{% code-tabs %}
{% code-tabs-item title="my\_pos 인덱스에 수사\(NR\)을 제거하는 my\_pos\_f 토큰필터 지정" %}
```javascript
PUT my_pos
{
  "settings": {
...
{% tab title="request" %}
{% code-tabs %}
{% code-tabs-item title="my\_pos\_f 토큰필터로 \"다섯아이가\" 분석" %}
```javascript
GET my_pos/_analyze
{
  "tokenizer": "nori_tokenizer",
...
{% tab title="response" %}
{% code-tabs %}
{% code-tabs-item title="my\_pos\_f 토큰필터로 \"다섯아이가\" 분석 결과" %}
```javascript
{
  "tokens" : [
    {
...
{% tab title="request" %}
{% code-tabs %}
{% code-tabs-item title="nori\_readingform 토큰필터로 \"春夏秋冬\"\(춘하추동\) 분석" %}
```javascript
GET _analyze
{
  "tokenizer": "nori_tokenizer",
...
{% tab title="response" %}
{% code-tabs %}
{% code-tabs-item title="nori\_readingform 토큰필터로 \"春夏秋冬\"\(춘하추동\) 분석 결과" %}
```javascript
{
  "tokens" : [
    {
...
{% tab title="request" %}
{% code-tabs %}
{% code-tabs-item title="\"explain\": true 옵션을 이용해서 분석 정보 표시" %}
```javascript
GET _analyze
{
  "tokenizer": "nori_tokenizer",
...
{% tab title="response" %}
{% code-tabs %}
{% code-tabs-item title="\"explain\": true 옵션을 이용해서 분석 정보 표시 결과" %}
```javascript
{
  "detail" : {
